package com.cg.go.greatoutdoor.cartItem.dto;
...
public class CartItemDetails {
	...
	public CartItemDetails(Integer userId, Map<ProductEntity, Integer> products, double cartTotalPrice,
			long totalQuantity) {
